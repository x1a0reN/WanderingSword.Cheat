void PopulateTab_Battle(UBPMV_ConfigView2_C* CV, APlayerController* PC)
{
	...
	GTab2DamageBoostToggle = AddToggle(SwitchBox, L"伤害加倍");
	AddToggle(SwitchBox, L"招式无视野冷却");
	...
	GTab2DamageMultiplierSlider = AddSlider(RatioBox, L"伤害倍数");
	if (GTab2DamageMultiplierSlider && GTab2DamageMultiplierSlider->VolumeSlider)
	{
		GTab2DamageMultiplierSlider->VolumeSlider->MinValue = 1.0f;
		GTab2DamageMultiplierSlider->VolumeSlider->MaxValue = 10.0f;
		GTab2DamageMultiplierSlider->VolumeSlider->StepSize = 1.0f;
		GTab2DamageMultiplierSlider->VolumeSlider->SetValue(2.0f);
	}
