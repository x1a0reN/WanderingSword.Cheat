...
extern "C" __declspec(dllexport) BOOL WINAPI Proxy_GetFileVersionInfoA(LPCSTR a, DWORD b, DWORD c, LPVOID d)
{
	return g_pGetFileVersionInfoA(a, b, c, d);
}

extern "C" __declspec(dllexport) BOOL WINAPI Proxy_GetFileVersionInfoW(LPCWSTR a, DWORD b, DWORD c, LPVOID d)
{
	return g_pGetFileVersionInfoW(a, b, c, d);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_GetFileVersionInfoSizeA(LPCSTR a, LPDWORD b)
{
	return g_pGetFileVersionInfoSizeA(a, b);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_GetFileVersionInfoSizeW(LPCWSTR a, LPDWORD b)
{
	return g_pGetFileVersionInfoSizeW(a, b);
}

extern "C" __declspec(dllexport) BOOL WINAPI Proxy_GetFileVersionInfoExA(DWORD a, LPCSTR b, DWORD c, DWORD d, LPVOID e)
{
	return g_pGetFileVersionInfoExA(a, b, c, d, e);
}

extern "C" __declspec(dllexport) BOOL WINAPI Proxy_GetFileVersionInfoExW(DWORD a, LPCWSTR b, DWORD c, DWORD d, LPVOID e)
{
	return g_pGetFileVersionInfoExW(a, b, c, d, e);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_GetFileVersionInfoSizeExA(DWORD a, LPCSTR b, LPDWORD c)
{
	return g_pGetFileVersionInfoSizeExA(a, b, c);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_GetFileVersionInfoSizeExW(DWORD a, LPCWSTR b, LPDWORD c)
{
	return g_pGetFileVersionInfoSizeExW(a, b, c);
}

extern "C" __declspec(dllexport) BOOL WINAPI Proxy_VerQueryValueA(LPCVOID a, LPCSTR b, LPVOID* c, PUINT d)
{
	return g_pVerQueryValueA(a, b, c, d);
}

extern "C" __declspec(dllexport) BOOL WINAPI Proxy_VerQueryValueW(LPCVOID a, LPCWSTR b, LPVOID* c, PUINT d)
{
	return g_pVerQueryValueW(a, b, c, d);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerFindFileA(DWORD a, LPCSTR b, LPCSTR c, LPCSTR d, LPSTR e, PUINT f, LPSTR g, PUINT h)
{
	return g_pVerFindFileA(a, b, c, d, e, f, g, h);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerFindFileW(DWORD a, LPCWSTR b, LPCWSTR c, LPCWSTR d, LPWSTR e, PUINT f, LPWSTR g, PUINT h)
{
	return g_pVerFindFileW(a, b, c, d, e, f, g, h);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerInstallFileA(DWORD a, LPCSTR b, LPCSTR c, LPCSTR d, LPCSTR e, LPCSTR f, LPSTR g, PUINT h)
{
	return g_pVerInstallFileA(a, b, c, d, e, f, g, h);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerInstallFileW(DWORD a, LPCWSTR b, LPCWSTR c, LPCWSTR d, LPCWSTR e, LPCWSTR f, LPWSTR g, PUINT h)
{
	return g_pVerInstallFileW(a, b, c, d, e, f, g, h);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerLanguageNameA(DWORD a, LPSTR b, DWORD c)
{
	return g_pVerLanguageNameA(a, b, c);
}

extern "C" __declspec(dllexport) DWORD WINAPI Proxy_VerLanguageNameW(DWORD a, LPWSTR b, DWORD c)
{
	return g_pVerLanguageNameW(a, b, c);
}

extern "C" __declspec(dllexport) int WINAPI Proxy_GetFileVersionInfoByHandle(int a, LPCWSTR b, DWORD c, DWORD d)
{
